...
# Order the columns
setcolorder(IOTC_CA_M_LEVEL0, neworder = c("fishing_fleet", "time_start", "time_end", "geographic_identifier", "gear_type", "fishing_mode", "species", "measurement", "measurement_type", "measurement_value", "measurement_unit", "measurement_processing_level"))
